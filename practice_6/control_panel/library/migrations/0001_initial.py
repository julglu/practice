...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'library_book', (
            ...
            ('publication_date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime.now)),
        ))
        ...
        db.create_table(u'library_booksimage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('small_cover', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
            ('zoomed_cover', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
